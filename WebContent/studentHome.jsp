...
<%
  ...
  try{
	  ...
	  String sql="SELECT * FROM student INNER JOIN result WHERE student.rollNo=result.rollNo and student.rollNo='"+rollNo+"'";
	  ResultSet rs=st.executeQuery(sql);
	  if(rs.next()){
%>


<img src="images/logo1.png"  align="left"width="150" height="150">
<center><img src="images/cat.jpg" width="150" height="150">
<img src="images/dhruba.jpg" align="right"  width="150" height="150"></center>
    <a href="necOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
<body>
  <table>
    ...
    <hr class="new1">
  <center><h6>Note: Any errors occur then contact me at dhruba.roka123@gmail.com.
Designed & Developed by Dhruba Roka.</h6></center>
  <hr class="new1">
<center><h6>© 2020 Nepal Engineering College All Rights Reserved.<br><b>Developer: Dhruba Roka, 9816129113</b></h6></center> 
  <hr class="new1">
</body>
<%
	  }
else{
response.sendRedirect("errorNecOneView.html");	
}
  }
