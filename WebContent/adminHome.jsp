...
<title>NEC</title>
<body>
<img src="images/logo1.png"  align="left"width="100" height="100">
<center><img src="images/cat.jpg" width="100" height="100">
<img src="images/dhruba.jpg" align="right"  width="100" height="100"></center>
...
<!--  to show all registered Students from db   -->   
...
<section>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <!--  to show all Students result from db   -->   
   <%@page import="Project.ConnectionProvider"%>
  <%@page import="java.sql.*"%>
<%
...
<tr>
 ...
 <% 
  ...
  %>
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact me at dhruba.roka123@gmail.com.
Designed & Developed by Dhruba Roka.</h5></center>
  <hr class="new1">
<center><h5>© 2020 Nepal Engineering College All Rights Reserved.</h5></center> 
  <hr class="new1">
<br>
</body>
</html>